 ...
 * document `<head>` via Vite. Consumers therefore get BOTH the scoped Lit CSS
 * template (`mapStyles` / `mapStylesText`) AND the global Leaflet stylesheet
 * from a single import — no need to duplicate `import 'leaflet/dist/leaflet.css'`
 * in every entry component.
 *
 * Rule: any Lit/Leaflet entry imports ONLY this file for map styling. See
