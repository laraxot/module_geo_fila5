...
beforeEach(function () {
    ...
    $this->mockCalculateDistanceAction = new CalculateDistanceAction($this->mockDistanceMatrixAction);
    $this->action = new FilterCoordinatesInRadiusAction($this->mockCalculateDistanceAction);
});
...
it('filters coordinates within radius', function (): void {
    ...
    // Act
    $result = $this->action->execute($centerLat, $centerLng, $coordinates, $radius);
