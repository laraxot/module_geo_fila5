...
it('throws exception for unsupported format', function (): void {
    expect(fn () => // @var mixed action->execute(45.4642, 9.1900, 'invalid';
});

it('handles edge case coordinates', function (): void {
    // Test extreme valid coordinates
    $result = // @var mixed action->execute(90, 180, 'decimal';
    ...
    $result = // @var mixed action->execute(90, 180, 'dms';
...
it('handles high precision coordinates', function (): void {
    $result = // @var mixed action->execute(45.123456, 9.654321, 'decimal';
    expect($result)->toBe('45.123456, 9.654321');

    $result = // @var mixed action->execute(45.123456, 9.654321, 'dms';
