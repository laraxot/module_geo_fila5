var u=Object.defineProperty;var d=(a,t,e)=>t in a?u(a,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):a[t]=e;var c=(a,t,e)=>d(a,typeof t!="symbol"?t+"":t,e);import{d as p,e as m,c as n,L as r}from"./leaflet-src.js";import{m as _,g,c as y}from"./map-picker-marker-config.js";class h extends p{createRenderRoot(){return this}constructor(){super(),this.latitude=null,this.longitude=null,this.defaultLatitude=41.9028,this.defaultLongitude=12.4964,this.zoom=15,this.height="400px",this.showSearch=!0,this.geolocateWhenEmpty=!1,this.address=null,this._map=null,this._marker=null,this._layers={},this._currentLayer="street",this._mapReady=!1,this._loading=!1,this._isProgrammaticUpdate=!1,this._resizeObserver=null}render(){const t=!!document.fullscreenElement;return n`
            <style>
            ...
            <div class="map-container ${t?"is-fullscreen":""}" style="--map-height: ${this.height}">
                ...
                ${m([],()=>n`<div class="map-picker-leaflet-pane" style="height: 100%;"></div>`)}
