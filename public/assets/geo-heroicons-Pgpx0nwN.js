...
`,Ke=Ge.cssText,qe=`/assets/geo/assets/map-picker-marker-fallback-Bu_stv-I.svg`,Je={iconSize:[35,45],iconAnchor:[17,42],popupAnchor:[1,-32]},Ye={iconUrl:qe,...Je,className:`map-picker-marker map-picker-marker--primary`},Xe={iconUrl:qe,...Je,className:`map-picker-marker map-picker-marker--fallback`};function Ze(e){return(e??``).toString().trim().toLowerCase()===`fallback`?Xe:Ye}function Qe(e,t=`default`){return(t??``).toString().trim().toLowerCase()===`fallback`?e.icon(Ze(`fallback`)):e.divIcon({className:`map-picker-marker map-picker-marker--custom`,html:`<div class="map-picker-marker__inner" aria-hidden="true">
    ...
    </div>`,iconSize:[32,45],iconAnchor:[22,54],popupAnchor:[0,-42]})}var F={"magnifying-glass":M`${`<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" xmlns="http://www.w3.org/2000/svg"><circle cx="11" cy="11" r="8"/><line x1="21" y1="21" x2="16.65" y2="16.65"/></svg>
`}`,"arrows-pointing-out":M`${`<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" xmlns="http://www.w3.org/2000/svg"><path d="M15 3h6v6M9 21H3v-6M21 3l-7 7M3 21l7-7"/></svg>
`}`,"arrows-pointing-in":M`${`<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" xmlns="http://www.w3.org/2000/svg"><path d="M4 14h6v6M20 10h-6V4M14 10l7-7M10 14l-7 7"/></svg>
...
`}`,"squares-2x2":M`${`<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" xmlns="http://www.w3.org/2000/svg"><polygon points="12 2 2 7 12 12 22 7 12 2"/><polyline points="2 17 12 22 22 17"/><polyline points="2 12 12 17 22 12"/></svg>
`}`,plus:M`${`<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" xmlns="http://www.w3.org/2000/svg"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg>
`}`,minus:M`${`<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" xmlns="http://www.w3.org/2000/svg"><line x1="5" y1="12" x2="19" y2="12"/></svg>
