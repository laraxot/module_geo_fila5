import{n as e}from"./chunk-ChgXRy64.js";import{i as t,l as n,n as r,s as i,t as a}from"./leaflet-src-BC8gaMNm.js";import{n as o,t as s}from"./map-picker-marker-config-zJebw5EK.js";var c=e(a(),1),l=class extends i{static properties={latitude:{type:Number},longitude:{type:Number},defaultLatitude:{type:Number,attribute:`default-latitude`},defaultLongitude:{type:Number,attribute:`default-longitude`},zoom:{type:Number},height:{type:String}};createRenderRoot(){return this}constructor(){super(),this.latitude=null,this.longitude=null,this.defaultLatitude=41.9028,this.defaultLongitude=12.4964,this.zoom=15,this.height=`400px`,this._map=null,this._marker=null,this._layers={},this._currentLayer=`street`,this._mapReady=!1,this._loading=!1,this._isProgrammaticUpdate=!1,this._resizeObserver=null}render(){let e=!!document.fullscreenElement,i=this.height||`400px`;return n`
            <style>
            ...
            <div class="map-container ${e?`is-fullscreen`:``}" style="--map-height: ${i}">
                ${o([],()=>n`<div class="map-picker-leaflet-pane" style="height: 100%;"></div>`)}

                <div class="layer-controls-overlay">
                    <button class="ctrl-btn" type="button" @click="${this._toggleFullscreen}" title="Fullscreen">
                        ${r(`arrows-pointing-out`)}
                    </button>
