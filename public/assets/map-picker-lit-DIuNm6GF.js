import{a as e,n as t,s as n,t as r,u as i}from"./leaflet-src-DxJVfkjP.js";import{i as a,n as o,t as s}from"./map-picker-marker-config-DNnK0FhP.js";var c=i(r(),1),l=class extends e{static properties={latitude:{type:Number},longitude:{type:Number},defaultLatitude:{type:Number,attribute:`default-latitude`},defaultLongitude:{type:Number,attribute:`default-longitude`},zoom:{type:Number},height:{type:String},showSearch:{type:Boolean,attribute:`show-search`},geolocateWhenEmpty:{type:Boolean,attribute:`geolocate-when-empty`},address:{type:String,attribute:`address`}};createRenderRoot(){return this}constructor(){super(),this.latitude=null,this.longitude=null,this.defaultLatitude=41.9028,this.defaultLongitude=12.4964,this.zoom=15,this.height=`400px`,this.showSearch=!0,this.geolocateWhenEmpty=!1,this.address=null,this._map=null,this._marker=null,this._layers={},this._currentLayer=`street`,this._mapReady=!1,this._loading=!1,this._isProgrammaticUpdate=!1,this._resizeObserver=null}render(){return n`
            <style>
            ...
            <div class="map-container ${document.fullscreenElement?`is-fullscreen`:``}" style="--map-height: ${this.height}">
                ...
                ${a([],()=>n`<div class="map-picker-leaflet-pane" style="height: 100%;"></div>`)}
        ...
        `}_renderIcon(e){return t(e)}_renderSearch(){return n`
