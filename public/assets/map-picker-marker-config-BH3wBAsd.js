...
`,Ke=Ge.cssText,qe={zoomIn:M`<svg width="100%" height="100%" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg>`,zoomOut:M`<svg width="100%" height="100%" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="5" y1="12" x2="19" y2="12"/></svg>`,fullscreen:M`<svg width="100%" height="100%" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M15 3h6v6M9 21H3v-6M21 3l-7 7M3 21l7-7"/></svg>`,fullscreenExit:M`<svg width="100%" height="100%" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 14h6v6M20 10h-6V4M14 10l7-7M10 14l-7 7"/></svg>`,locate:M`<svg width="100%" height="100%" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><circle cx="12" cy="12" r="3"/><line x1="12" y1="2" x2="12" y2="5"/><line x1="12" y1="19" x2="12" y2="22"/><line x1="2" y1="12" x2="5" y2="12"/><line x1="19" y1="12" x2="22" y2="12"/></svg>`,layer:M`<svg width="100%" height="100%" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polygon points="12 2 2 7 12 12 22 7 12 2"/><polyline points="2 17 12 22 22 17"/><polyline points="2 12 12 17 22 12"/></svg>`,crosshair:M`<svg width="100%" height="100%" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><line x1="12" y1="2" x2="12" y2="22"/><line x1="2" y1="12" x2="22" y2="12"/></svg>`},Je=`/assets/geo/assets/map-picker-marker-fallback-Bu_stv-I.svg`,Ye={iconSize:[35,45],iconAnchor:[17,42],popupAnchor:[1,-32]},Xe={iconUrl:Je,...Ye,className:`map-picker-marker map-picker-marker--primary`},Ze={iconUrl:Je,...Ye,className:`map-picker-marker map-picker-marker--fallback`};function Qe(e){return(e??``).toString().trim().toLowerCase()===`fallback`?Ze:Xe}function F(e,t=`default`){return(t??``).toString().trim().toLowerCase()===`fallback`?e.icon(Qe(`fallback`)):e.divIcon({className:`map-picker-marker map-picker-marker--custom`,html:`<div class="map-picker-marker__inner" aria-hidden="true">
    ...
    </div>`,iconSize:[32,45],iconAnchor:[22,54],popupAnchor:[0,-42]})}export{We as a,M as c,Ke as i,c as l,qe as n,Ue as o,Ge as r,Re as s,F as t};
