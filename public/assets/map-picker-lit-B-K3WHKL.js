import{n as e}from"./chunk-ChgXRy64.js";import{l as t,n,r,s as i,t as a}from"./leaflet-src-BC8gaMNm.js";import{n as o,t as s}from"./map-picker-marker-config-zJebw5EK.js";var c=e(a(),1),l=class extends i{static properties={latitude:{type:Number},longitude:{type:Number},defaultLatitude:{type:Number,attribute:`default-latitude`},defaultLongitude:{type:Number,attribute:`default-longitude`},zoom:{type:Number},height:{type:String},showSearch:{type:Boolean,attribute:`show-search`},geolocateWhenEmpty:{type:Boolean,attribute:`geolocate-when-empty`},address:{type:String,attribute:`address`}};createRenderRoot(){return this}constructor(){super(),this.latitude=null,this.longitude=null,this.defaultLatitude=41.9028,this.defaultLongitude=12.4964,this.zoom=15,this.height=`400px`,this.showSearch=!0,this.geolocateWhenEmpty=!1,this.address=null,this._map=null,this._marker=null,this._layers={},this._currentLayer=`street`,this._mapReady=!1,this._loading=!1,this._isProgrammaticUpdate=!1,this._resizeObserver=null}render(){return t`
            ...
            <div class="map-container ${document.fullscreenElement?`is-fullscreen`:``}" style="--map-height: ${this.height}">
                ...
                ${o([],()=>t`<div class="map-picker-leaflet-pane" style="height: 100%;"></div>`)}
        ...
        `}_renderIcon(e){return n(e)}_renderSearch(){return t`
