import{d as e,f as t,i as n,m as r,n as i,o as a,r as o,s,t as c,v as l}from"./leaflet-src-Bmf1u-60.js";import{n as u,t as d}from"./map-picker-marker-config-D7dXugGV.js";e();var f=l(c(),1);s(),n(),o();var p=class extends t{static properties={latitude:{type:Number},longitude:{type:Number},defaultLatitude:{type:Number,attribute:`default-latitude`},defaultLongitude:{type:Number,attribute:`default-longitude`},zoom:{type:Number},height:{type:String}};createRenderRoot(){return this}constructor(){super(),this.latitude=null,this.longitude=null,this.defaultLatitude=41.9028,this.defaultLongitude=12.4964,this.zoom=15,this.height=`400px`,this._map=null,this._marker=null,this._layers={},this._currentLayer=`street`,this._mapReady=!1,this._loading=!1,this._isProgrammaticUpdate=!1,this._resizeObserver=null}render(){let e=!!document.fullscreenElement,t=this.height||`400px`;return r`
            <style>
            ...
            <div class="map-container ${e?`is-fullscreen`:``}" style="--map-height: ${t}">
                ${u([],()=>r`<div class="map-picker-leaflet-pane" style="height: 100%;"></div>`)}
