---
title: "On-Demand Pattern — Module Geo"
type: documentation
created: 2026-05-11
updated: 2026-05-11
...
| Ricerca locale | `qmd search "topic" -c Geo` |
| Wiki locale | `Read ./laravel/Modules/Geo/docs/wiki/index.md` |
...
3. **Mantieni la wiki aggiornata** — Dopo ogni task, aggiorna ./laravel/Modules/Geo/docs/wiki/log.md
