...
type: concept
module: Geo
tags: [geo, filament, xotbase, architecture]
created: 2026-07-16
updated: 2026-07-16
qmd: "Geo filament never extend Filament class XotBase mirror path"
related:
...
Nessuna classe in `Modules/Geo` estende una classe `Filament\...` direttamente.
