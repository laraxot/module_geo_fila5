...
1. Pest: `cd laravel && ./vendor/bin/pest laravel/Modules/Geo/tests`
2. PHPStan: `cd laravel && ./vendor/bin/phpstan analyse laravel/Modules/Geo/tests --level=5`
3. PHPMD: `phpmd laravel/Modules/Geo/tests text phpmd.xml`
