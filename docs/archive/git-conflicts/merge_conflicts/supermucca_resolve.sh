...
conflict_files=$(grep -r "<<git marker>" . --include="*.php" --include="*.json" --include="*.md" --include="*.sh" --include="*.js" --include="*.ts" --include="*.vue" --include="*.yaml" --include="*.yml" --include="*.xml" --include="*.txt" 2>/dev/null | cut -d: -f1 | sort -u)
