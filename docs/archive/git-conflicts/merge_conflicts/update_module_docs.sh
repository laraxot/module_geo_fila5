...
create_standard_doc_structure() {
  local module_name=$1
  local docs_dir="/var/www/_bases/base_<nome progetto>_fila5_mono/laravel/Modules/$module_name/docs"
...
update_module_documentation() {
  local module_name=$1
  local module_dir="/var/www/_bases/base_<nome progetto>_fila5_mono/laravel/Modules/$module_name"
...
update_all_modules_documentation() {
  local modules_dir="/var/www/_bases/base_<nome progetto>_fila5_mono/laravel/Modules"
...
update_main_modules_documentation() {
  local main_modules=("<nome progetto>" "User" "Xot" "UI" "Tenant")
