---
title: "Code Quality Improvement Report — Geo"
type: report
tags: [code-quality, phpstan, pest, maintainability]
module: "Geo"
created: 2026-07-17
updated: 2026-07-17
qmd: "code quality baseline PHPStan Pest strict types Laraxot Geo"
story: STORY-001
issues:
...
# Code Quality Improvement Report — Geo
...
| Indicatore | Valore |
|---|---:|
| File PHP applicativi/database/route | 271 |
| File di test PHP | 100 |
| Rapporto test/file PHP | 36% |
| Candidati senza strict types | 271 |
| Marker TODO/FIXME/HACK/XXX | 31 |
...
2. **resources/js/leaflet-src.js:1328:// TODO International date line? — debito eseguibile.** Verificare il caller e scegliere una sola uscita: implementare il comportamento con un test che fallisce prima della patch, oppure eliminare ramo e marker se non raggiungibili. Non lasciare il TODO come documentazione.
4. **resources/data/geo-points.js — file da 3305140 byte.** Prima verificare se è sorgente, fixture o artefatto generato. Gli artefatti generati vanno rimossi dal source tree e rigenerati dal build; per sorgenti reali separare per responsabilità mantenendo un solo entrypoint e aggiungere un test/smoke build.
...
Dalla cartella laravel/:
    ...
    ./vendor/bin/phpstan analyse Modules/Geo --memory-limit=-1
