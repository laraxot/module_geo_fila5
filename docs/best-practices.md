...
- Riutilizza sempre le classi base fornite dal modulo Xot
- Evita duplicazioni di codice tra moduli
- Usa i trait per condividere funzionalità comuni

### KISS (Keep It Simple, Stupid)
- Scrivi codice chiaro e leggibile
- Evita complessità non necessarie
- Scegli soluzioni semplici quando possibile

### SOLID
- Segui i principi SOLID nella progettazione delle classi
- Usa l'inversione di dipendenza quando appropriato
- Rispetta il principio di sostituzione di Liskov
