...
### 1.2 Principio Fondamentale: Modularità
...
- **UNICA ECCEZIONE: README.md può avere maiuscole**
...
**Cross-reference**: Vedi [docs2.txt](./docs2.txt#5-testing-e-qualità) per dettagli completi
...
### 8.2 Campi Array
Campi che memorizzano più valori (da input multi-select) devono essere castati a 'array':
...
- **[Gdpr Module](../../laravel/Modules/Gdpr/docs/README.md)**: Conformità e privacy
- **[Activity Module](../../laravel/Modules/Activity/docs/README.md)**: Logging attività
- **[Geo Module](../../laravel/Modules/Geo/docs/README.md)**: Dati geografici

---

> Consulta sempre [docs/collegamenti-documentazione.md](../../docs/collegamenti-documentazione.md) per la mappa aggiornata dei collegamenti e la policy di bidirezionalità.
