...
return [
    ...
    'fields' => [
        ...
        'center_lng' => ['label' => 'Longitudine Centro', 'tooltip' => '', 'helper_text' => '', 'description' => ''],
        'markers' => ['label' => 'Marcatori', 'tooltip' => '', 'helper_text' => '', 'description' => ''],
        'layers' => ['label' => 'Livelli', 'tooltip' => '', 'helper_text' => '', 'description' => ''],
        'style' => ['label' => 'Stile', 'tooltip' => '', 'helper_text' => '', 'description' => ''],
        'text' => ['label' => 'text', 'placeholder' => 'text', 'helper_text' => 'text', 'description' => 'text'],
        '_tpl' => ['label' => '_tpl', 'placeholder' => '_tpl', 'helper_text' => '_tpl', 'description' => '_tpl'],
    ],
