...
### 2. Options/Years
Never remove options from Selects or Filters

### 3. Array Keys
Never change named keys to indexed arrays

### 4. Actions
Never delete getHeaderActions() or custom actions

### 5. Blade Includes
Never replace @include with inline code

### 6. Traits
Never remove traits from models
