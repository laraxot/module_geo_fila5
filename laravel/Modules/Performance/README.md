# Performance: il modulo che trasforma complessita in vantaggio operativo
...
- [Action Update Gg Anno](./docs/action-update-gg-anno.md)
- [Action Update Gg Presenza Dalal](./docs/action-update-gg-presenza-dalal.md)
- [Action Update Perc Parttimepond Dalal](./docs/action-update-perc-parttimepond-dalal.md)
- [Architecture Rules](./docs/architecture-rules.md)
- [Bugfix Individuale Regionale Parental Scope](./docs/bugfix-individuale-regionale-parental-scope.md)
- [Confidence Guidelines](./docs/confidence_guidelines.md)
