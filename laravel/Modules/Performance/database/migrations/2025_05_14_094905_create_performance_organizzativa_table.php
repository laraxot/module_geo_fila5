 ...
 * Aggiunta colonna valutatore_id se non esiste, secondo regola Windsurf/Laraxot.
    ...
    public function up(): void
    {
        ...
        $this->tableUpdate(
            function (Blueprint $table): void {
                ...
                // Motivazione: richiesta dalla logica amministrativa per memorizzare l'importo totale per valutatore, vedi doc.
