...
use Modules\Performance\Models\PerformanceComportamenti as Model;
use Modules\Xot\Contracts\UserContract;
use Modules\Xot\Models\Policies\XotBasePolicy;

class PerformanceComportamentiPolicy extends XotBasePolicy
{
    /**
    ...
    public function view(UserContract $user, Model $model): bool
    {
        return $user->hasRole(['super-admin', 'admin', 'hr-manager'])
            || ($user->hasRole('evaluator') && $user->profile !== null && $user->profile->id === $model->valutatore_id); // @phpstan-ignore-line
    }
