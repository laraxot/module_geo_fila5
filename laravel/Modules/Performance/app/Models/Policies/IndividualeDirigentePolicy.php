...
use Modules\Performance\Models\IndividualeDirigente as Model;
use Modules\Xot\Contracts\UserContract;
use Modules\Xot\Models\Policies\XotBasePolicy;

class IndividualeDirigentePolicy extends XotBasePolicy
{
    /**
    ...
    {
        return $user->hasRole(['super-admin', 'admin', 'hr-manager'])
            || ($user->hasRole('director') && $user->profile !== null && $user->profile->matr === $model->matr);
    }
