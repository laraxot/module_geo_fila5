...
namespace Modules\Performance\Filament\Resources\IndividualeDipResource\Tables;
...
class IndividualeDipsTable extends XotBaseResourceTable
{
    public function getTableColumns(): array
    {
        return [
            ...
            */
            'type' => TextColumn::make('type')
                ->visible(fn () => ! in_array(HasParent::class, class_uses_recursive(IndividualeDipResource::getModel()))),
