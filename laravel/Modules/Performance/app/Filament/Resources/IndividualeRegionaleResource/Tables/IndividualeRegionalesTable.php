...
namespace Modules\Performance\Filament\Resources\IndividualeRegionaleResource\Tables;
...
class IndividualeRegionalesTable extends XotBaseResourceTable
{
    /**
    ...
    public function getTableColumns(): array
    {
        return [
            ...
            */
            'type' => TextColumn::make('type')
                ->visible(fn () => ! in_array(HasParent::class, class_uses_recursive(IndividualeRegionaleResource::getModel()))),
