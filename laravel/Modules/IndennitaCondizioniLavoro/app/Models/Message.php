 ...
 * @property-read Collection<int, \Modules\IndennitaCondizioniLavoro\Models\Message> $ancestors The model's recursive parents.
 * @property-read int|null $ancestors_count
 * @property-read Collection<int, \Modules\IndennitaCondizioniLavoro\Models\Message> $ancestorsAndSelf The model's recursive parents and itself.
 * @property-read int|null $ancestors_and_self_count
 * @property-read Collection<int, \Modules\IndennitaCondizioniLavoro\Models\Message> $bloodline The model's ancestors, descendants and itself.
 * @property-read int|null $bloodline_count
 * @property-read Collection<int, \Modules\IndennitaCondizioniLavoro\Models\Message> $childrenAndSelf The model's direct children and itself.
 * @property-read int|null $children_and_self_count
 * @property-read Collection<int, \Modules\IndennitaCondizioniLavoro\Models\Message> $descendants The model's recursive children.
 * @property-read int|null $descendants_count
 * @property-read Collection<int, \Modules\IndennitaCondizioniLavoro\Models\Message> $descendantsAndSelf The model's recursive children and itself.
 * @property-read int|null $descendants_and_self_count
 * @property-read Collection<int, \Modules\IndennitaCondizioniLavoro\Models\Message> $parentAndSelf The model's direct parent and itself.
 * @property-read int|null $parent_and_self_count
 * @property-read \Modules\IndennitaCondizioniLavoro\Models\Message|null $rootAncestor The model's topmost parent.
 * @property-read Collection<int, \Modules\IndennitaCondizioniLavoro\Models\Message> $siblings The parent's other children.
