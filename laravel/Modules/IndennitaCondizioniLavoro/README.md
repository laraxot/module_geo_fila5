# IndennitaCondizioniLavoro: il modulo che trasforma complessita in vantaggio operativo
...
- [Accessor Guard Audit](./docs/accessor-guard-audit.md)
- [Action Return Type Rule](./docs/action-return-type-rule.md)
