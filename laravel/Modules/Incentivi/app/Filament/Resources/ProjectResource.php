...
use Modules\Incentivi\Filament\Resources\ProjectResource\Pages\ListProjects;
use Modules\Incentivi\Filament\Resources\ProjectResource\Pages\ListSchedaLogActivities;
use Modules\Incentivi\Filament\Resources\ProjectResource\Pages\ManageProjectActivities;
use Modules\Incentivi\Filament\Resources\ProjectResource\Pages\ManageProjectEmployees;
use Modules\Incentivi\Filament\Resources\ProjectResource\Pages\ManageProjectPhases;
use Modules\Incentivi\Filament\Resources\ProjectResource\Pages\ManageProjectSettlements;
use Modules\Incentivi\Filament\Resources\ProjectResource\RelationManagers;
use Modules\Incentivi\Filament\Resources\ProjectResource\Resources\Activities\ActivityResource;
...
class ProjectResource extends XotBaseResource
{
    ...
    protected static ?\Filament\Pages\Enums\SubNavigationPosition $navPosition = SubNavigationPosition::Top;
    ...
    public static function getPages(): array
    {
        return [
            ...
            'activities' => ManageProjectActivities::route('/{record}/activities'),
            ...
            'employees' => ManageProjectEmployees::route('/{record}/employees'),
            'settlements' => ManageProjectSettlements::route('/{record}/settlements'),
            'phases' => ManageProjectPhases::route('/{record}/phases'),
            'log-activity' => ListSchedaLogActivities::route('/{record}/log-activities'),
    ...
    public static function getRecordSubNavigation(Page $page): array
    {
        return $page->generateNavigationItems([
            EditProject::class,
            ManageProjectEmployees::class,
            ManageProjectActivities::class,
            // ManageProjectPhases::class,
