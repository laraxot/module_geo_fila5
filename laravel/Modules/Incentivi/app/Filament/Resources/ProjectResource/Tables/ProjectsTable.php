...
namespace Modules\Incentivi\Filament\Resources\ProjectResource\Tables;
    ...
    public function getTableColumns(): array
    {
        ...
        return [
            ...
            'tipo' => TextColumn::make('tipo')
                ->searchable(),
            'stabi_dirigente_nome_stabi' => TextColumn::make('stabiDirigente.nome_stabi')
                ->sortable(),
            ...
            //     ->searchable()
            //     ->limit(30),
            'determina_di_aggiudicazione' => TextColumn::make('determina di aggiudicazione')
                ->searchable()
                ->toggleable(isToggledHiddenByDefault: true),
