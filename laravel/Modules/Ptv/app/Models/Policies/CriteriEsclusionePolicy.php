...
use Modules\Ptv\Models\CriteriEsclusione as Model;
...
class CriteriEsclusionePolicy extends XotBasePolicy
{
    ...
    {
        return $model->exists && $user->hasRole(['super-admin', 'admin', 'hr-manager', 'evaluator']);
    }
    ...
    {
        return $model->exists && $user->hasRole(['super-admin', 'admin', 'hr-manager']);
    }
    ...
    {
        return $model->exists && $user->hasRole(['super-admin', 'admin']);
    }
    ...
    {
        return $model->exists && $user->hasRole('super-admin');
    }
