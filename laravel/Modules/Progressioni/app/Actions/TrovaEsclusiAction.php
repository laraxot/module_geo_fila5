...
class TrovaEsclusiAction
{
    ...
    public function checkScheda(array $params, int $year): array
    {
        ...
        /** @var \Modules\Progressioni\Models\Schede|\Modules\Progressioni\Models\Progressioni $scheda */
        $scheda = $params['scheda'];
        /** @var array{scheda: \Modules\Progressioni\Models\Schede|\Modules\Progressioni\Models\Progressioni, criteri_esclusione: array<string, mixed>, criteri_option: array<string, mixed>} $typedParams */
        $typedParams = $params;
    ...
    public function check(string $criterio_name, mixed $criterio_value, \Modules\Progressioni\Models\Schede $scheda, int $year): string
    {
    ...
    public function checkMinGgRuolo(array $parz, \Modules\Progressioni\Models\Schede $scheda): string
    {
        extract($parz);
    ...
    public function checkMinPerfIndCountLast3Years(array $parz, \Modules\Progressioni\Models\Schede $scheda): string
    {
        extract($parz);
    ...
    public function checkMinGgPosiz1InSede(array $parz, \Modules\Progressioni\Models\Schede $scheda): string
    {
        extract($parz);
    ...
    public function checkMinGgCatecoPosfunNoAsz(array $parz, \Modules\Progressioni\Models\Schede $scheda): string
    {
        extract($parz);
    ...
    public function checkMinGgCatecoPosfunInSedeNoAsz(array $parz, \Modules\Progressioni\Models\Schede $scheda): string
    {
        extract($parz);
        /*
        dddx(
    ...
    public function checkMinGgCatecoPosfunLavoratiInSede(array $parz, \Modules\Progressioni\Models\Schede $_scheda): string
    {
        extract($parz);
    ...
    public function checkPresentiIlGiorno(array $parz, \Modules\Progressioni\Models\Schede $_scheda): string
    {
        extract($parz);
    ...
    public function checkListaPropro(array $parz, \Modules\Progressioni\Models\Schede $scheda): string
    {
        extract($parz);
    ...
    public function checkListaPosiz(array $parz, \Modules\Progressioni\Models\Schede $scheda): string
    {
        extract($parz);
    ...
    public function checkListaProproPosfun(array $parz, \Modules\Progressioni\Models\Schede $scheda): string
    {
        extract($parz);
    ...
    public function checkDisci(array $parz, \Modules\Progressioni\Models\Schede $scheda): string
    {
        extract($parz);
        if (! isset($disci)) {
    ...
    public function checkListaAszTipCodEsclusoSubito(array $parz, \Modules\Progressioni\Models\Schede $scheda): string
    {
        extract($parz);
    ...
    public function checkMinGgPropro(array $parz, \Modules\Progressioni\Models\Schede $_scheda): string
    {
        extract($parz);
    ...
    public function checkMinGgProproPosfun(array $parz, \Modules\Progressioni\Models\Schede $_scheda): string
    {
        extract($parz);
    ...
    public function checkMinGgAnno(array $parz, \Modules\Progressioni\Models\Schede $scheda): string
    {
        extract($parz);
    ...
    public function checkMinGgTempoDeterminato(array $parz, \Modules\Progressioni\Models\Schede $_scheda): string
    {
        extract($parz);
    ...
    public function checkMinGgEffettuati(array $parz, \Modules\Progressioni\Models\Schede $_scheda): string
    {
        extract($parz);
    ...
    public function checkNoposizList(array $parz, \Modules\Progressioni\Models\Schede $scheda): string
    {
        extract($parz);
    ...
    public function checkNoproproList(array $parz, \Modules\Progressioni\Models\Schede $scheda): string
    {
        extract($parz);
    ...
    public function checkNoposfunList(array $parz, \Modules\Progressioni\Models\Schede $scheda): string
    {
        extract($parz);
    ...
    public function checkNodisci1List(array $parz, \Modules\Progressioni\Models\Schede $scheda): string
    {
        extract($parz);
    ...
    public function checkMaxGgAssenzeAnno(array $parz, \Modules\Progressioni\Models\Schede $scheda): string
    {
        extract($parz);
    ...
    public function checkDateMinAssunz(array $parz, \Modules\Progressioni\Models\Schede $scheda): string
    {
        extract($parz);
