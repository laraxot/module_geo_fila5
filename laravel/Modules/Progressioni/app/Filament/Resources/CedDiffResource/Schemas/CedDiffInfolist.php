...
namespace Modules\Progressioni\Filament\Resources\CedDiffResource\Schemas;

use Filament\Infolists\Components\TextEntry;
use Filament\Schemas\Components\Component;
use Modules\Xot\Filament\Resources\Schemas\XotBaseResourceInfolist;

class CedDiffInfolist extends XotBaseResourceInfolist
{
    /**
    ...
    public static function getInfolistSchema(): array<string, mixed>
    {
        return [
            ...
            'importo_forzato' => TextEntry::make('importo_forzato'),
            'importo_base' => TextEntry::make('importo_base'),
            'voce' => TextEntry::make('voce'),
            'descrizione' => TextEntry::make('descrizione'),
            'istituto' => TextEntry::make('istituto'),
            'tipo' => TextEntry::make('tipo'),
            'ruolo' => TextEntry::make('ruolo'),
            'ruolo_txt' => TextEntry::make('ruolo_txt'),
            'profilo' => TextEntry::make('profilo'),
            'profilo_txt' => TextEntry::make('profilo_txt'),
            'posizione_funzionale' => TextEntry::make('posizione_funzionale'),
            'descr_posizione_funzionale' => TextEntry::make('descr_posizione_funzionale'),
            'stabilimento' => TextEntry::make('stabilimento'),
