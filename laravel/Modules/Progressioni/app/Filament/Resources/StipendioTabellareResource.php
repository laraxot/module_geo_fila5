...
use Modules\Progressioni\Filament\Resources\StipendioTabellareResource\Pages\CreateStipendioTabellare;
use Modules\Progressioni\Filament\Resources\StipendioTabellareResource\Pages\EditStipendioTabellare;
use Modules\Progressioni\Filament\Resources\StipendioTabellareResource\Pages\ListStipendioTabellares;
...
class StipendioTabellareResource extends XotBaseResource
{
    ...
    public static function getPages(): array
    {
        return [
            ...
            'create' => CreateStipendioTabellare::route('/create'),
            'edit' => EditStipendioTabellare::route('/{record}/edit'),
        ];
    }
}
