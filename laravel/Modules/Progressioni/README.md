# Progressioni: il modulo che trasforma complessita in vantaggio operativo
...
- [Activity Log Override Rationale](./docs/activity-log-override-rationale.md)
- [Architecture Rules](./docs/architecture-rules.md)
- [Compila Scheda Fix](./docs/compila-scheda-fix.md)
