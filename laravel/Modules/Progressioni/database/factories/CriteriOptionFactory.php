...
class CriteriOptionFactory extends Factory
{
     ...
     *
     * @var class-string<CriteriOption>
     */
    ...
    public function definition(): array
    {
        ...
        $criterio = (string) $this->faker->randomElement([
            'min_gg_ruolo',
            'min_gg_anno',
            'min_valutazioni',
            'min_punteggio',
        ...
        return [
            'post_type' => 'criteri_option',
            'criterio' => $criterio,
            'valore' => $this->getValueForCriterio($criterio),
            'anno' => $anno,
