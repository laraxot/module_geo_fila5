 ...
 * @method static Builder<static>|Module whereActivationDate($value)
 * @method static Builder<static>|Module whereAssets($value)
 * @method static Builder<static>|Module whereConfig($value)
 * @method static Builder<static>|Module whereDeactivationDate($value)
 * @method static Builder<static>|Module whereDependencies($value)
 * @method static Builder<static>|Module whereEnabled($value)
 * @method static Builder<static>|Module whereErrorLog($value)
 * @method static Builder<static>|Module whereInstalledAt($value)
 * @method static Builder<static>|Module whereIsActive($value)
 * @method static Builder<static>|Module whereLaravelVersion($value)
 * @method static Builder<static>|Module whereMetadata($value)
 * @method static Builder<static>|Module wherePermissions($value)
 * @method static Builder<static>|Module wherePhpVersion($value)
 * @method static Builder<static>|Module whereRoutes($value)
 * @method static Builder<static>|Module whereSettings($value)
 * @method static Builder<static>|Module whereSlug($value)
 * @method static Builder<static>|Module whereUpdateHistory($value)
 * @method static Builder<static>|Module whereUsageStatistics($value)
 * @method static Builder<static>|Module whereVersion($value)
 * @mixin \Eloquent
 */
