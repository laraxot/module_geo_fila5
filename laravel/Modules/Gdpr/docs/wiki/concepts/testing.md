...
1. Pest: `cd laravel && ./vendor/bin/pest laravel/Modules/Gdpr/tests`
2. PHPStan: `cd laravel && ./vendor/bin/phpstan analyse laravel/Modules/Gdpr/tests --level=5`
3. PHPMD: `phpmd laravel/Modules/Gdpr/tests text phpmd.xml`
