---
title: "On-Demand Pattern — Module Gdpr"
type: documentation
created: 2026-05-11
updated: 2026-05-11
...
| Ricerca locale | `qmd search "topic" -c Gdpr` |
| Wiki locale | `Read ./laravel/Modules/Gdpr/docs/wiki/index.md` |
...
3. **Mantieni la wiki aggiornata** — Dopo ogni task, aggiorna ./laravel/Modules/Gdpr/docs/wiki/log.md
