...
class NationalFlagSelect extends Select
{
    ...
    protected function getCountryOptions(): array
    {
        ...
        $countries = Arr::sort($countries, static function ($c) {
    ...
    protected function getFilteredCountryOptions(string $search): array
    {
        ...
        $filteredCountries = array_filter($countries, static function ($country) use ($searchLower) {
            // PHPStan L10: Type narrowing for country array
        ...
        $filteredCountries = Arr::sort($filteredCountries, static function ($c) {
            return is_array($c) && isset($c['name']) ? $c['name'] : '';
        });
