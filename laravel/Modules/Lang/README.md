# Lang: il modulo che trasforma complessita in vantaggio operativo
...
- [Index](./docs/INDEX.md)
- [Locale Management](./docs/LOCALE_MANAGEMENT.md)
- [Mcamara Implementation Guide](./docs/MCAMARA_IMPLEMENTATION_GUIDE.md)
