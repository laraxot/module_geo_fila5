# Activity: il modulo che trasforma complessita in vantaggio operativo

Activity logging and event sourcing module for the Laraxot ecosystem: audit trail, user actions tracking, and CQRS event store.
...
- [00 Index 1](./docs/00-index-1.md)
- [00 Index](./docs/00-index.md)
- [Bad Practices](./docs/BAD_PRACTICES.md)
- [Best Practices](./docs/BEST_PRACTICES.md)
- [Business Logic Analysis](./docs/BUSINESS_LOGIC_ANALYSIS.md)
