---
title: "Code redundancy audit — Pdnd"
type: source
status: draft
...
- `TipoIdSchedaSoggettoComune.php` x3
- `TipoLuogoEvento.php` x3
- `TipoLocalita.php` x4
- `TipoComune.php` x4
- `TipoGeneralita.php` x3
- `TipoCodiceFiscale.php` x3
- `TipoDatiRichiestaE002.php` x4
- `TipoVerificaE002.php` x3
- `RichiestaE002.php` x4
- `TipoCriteriRicercaE002.php` x4
- `TipoDatiSoggettiEnte.php` x4
- `TipoIdentificativi.php` x4

### File grandi
- `app/Services/Client/PdndClient.php`: 868 righe
- `app/Services/Anpr/Services/C003/C003Service.php`: 506 righe
- `app/Services/Anpr/Services/C007/C007Service.php`: 433 righe
- `app/Services/Anpr/Services/C030/C030Service.php`: 412 righe
