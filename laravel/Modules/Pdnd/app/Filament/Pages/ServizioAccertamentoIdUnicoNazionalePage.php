    ...
    public function send(): void
    {
        try {
            ...
            if (isset($risultatoC030Service['successo']) && $risultatoC030Service['successo']) {
                ...
                $cleanedIdAnpr = preg_replace('/[^\w\s-]/', '', (string) $idAnprValue);
                $this->idAnpr = $cleanedIdAnpr;
                ...
                // $c001Service = new C003Service(app(PdndClientService::class));
                // $risultatoC001Service = $c001Service->cercaInVita($this->idAnpr);
            } else {
