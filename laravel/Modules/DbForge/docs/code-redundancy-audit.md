---
title: "Code redundancy audit — DbForge"
type: source
status: draft
...
| Voce | Valore |
|---|---:|
| File PHP analizzati | 48 |
| Rischio ridondanza | high |
| Basename duplicati locali | 0 |
| Hash normalizzati duplicati cross-owner | 0 |
...
### File grandi
- `database/factories/DbForgeSchemaFactory.php`: 636 righe
- `app/Console/Commands/AnalyzeNamingCommand.php`: 566 righe
- `database/factories/DbForgeQueryLogFactory.php`: 443 righe
- `app/Console/Commands/DatabaseSchemaExporterCommand.php`: 384 righe
- `database/factories/DbForgeBackupFactory.php`: 359 righe
...
- `GenerateModelByModelClassCommand`
- `ImportMdbToMySQL`
- `GenerateFormCommand`
