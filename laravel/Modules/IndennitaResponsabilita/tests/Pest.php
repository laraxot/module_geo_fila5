...
expect()->extend('toBeIndennitaResponsabilita', fn () => $this->toBeInstanceOf(IndennitaResponsabilita::class));
...
| expose helpers as global functions to help you to reduce the number of lines of
