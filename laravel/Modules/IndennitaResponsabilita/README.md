# IndennitaResponsabilita: il modulo che trasforma complessita in vantaggio operativo
...
- [Activity Log Integration](./docs/activity-log-integration.md)
- [Anag Relationship Conflict Resolution](./docs/anag-relationship-conflict-resolution.md)
- [Analysis Summary](./docs/analysis-summary.md)
- [Api](./docs/api.md)
