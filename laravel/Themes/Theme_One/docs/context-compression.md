# KiloCLI Contestazione Contesto Configurazione per Theme_One

Configurazione consigliata per gestire i limiti di token (262144) con compressione contesto durante lo sviluppo con Tema Theme_One:
...
- [Tema Theme_One Documentation](/docs/wiki/theme_documentation)

# Note
- Questa configurazione si applica a tutti i template del tema Theme_One
