...
Theme Zero carries large frontend, chart, and quality-guideline docs. Use the local wiki first, then let the shared optimizer reduce repeated tool output during theme work.
